  ...
  return (
    <div>
      <div className="w-full bg-white flex items-center justify-between border border-white rounded-[10px] mb-[20px] mt-[10px] h-[60px]">
        <div className="flex justify-end items-center h-full">
          <div className="relative h-full flex items-center">
            <TableFilter table={table as TanstackTable<Supervisor>} />
        ...
        <div className="flex justify-start">
          <div className="relative">
            ...
            <Button className="pl-12 h-[40px]">
              <Link href="/director/manage/supervisor/add">Thêm giám thị</Link>
            </Button>
          </div>
        </div>
      </div>
      ...
      {table.getRowModel().rows?.length > 0 && (
        <DataTablePagination table={table as TanstackTable<Supervisor>} />
      )}
    </div>
  );
}
