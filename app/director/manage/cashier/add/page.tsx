...
export default function AddCashier() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      console.log("Tạo thu ngân thành công:", data);
      toast.success("Tạo thu ngân thành công");
      router.push("/director/manage/cashier/list");
    } catch (err) {
      console.log("Tạo thu ngân thất bại: " + err);
      toast.error("Tạo thu ngân thất bại");
    }
  }
