...
interface WarningStudentCardProps {
  month: number;
}

const WarningStudentCard: React.FC<WarningStudentCardProps> = ({ month }) => {
...
export default WarningStudentCard;
