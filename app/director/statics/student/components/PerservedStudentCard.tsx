...
interface PreservedStudentCardProps {
  month: number;
}

const PreservedStudentCard: React.FC<PreservedStudentCardProps> = ({
  month,
}) => {
...
export default PreservedStudentCard;
