              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="w-full flex flex-col">
                    <FormLabel className="font-normal">Tên lớp học</FormLabel>
                    <FormControl>
          ...
          <div className="w-full self-stretch inline-flex justify-between items-center mt-[10px]">
            <div className="w-[500px] inline-flex flex-col justify-start items-start gap-5">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="w-full flex flex-col">
                    <FormLabel className="font-normal">Khối</FormLabel>
                    <FormControl>
                      <Select
                        onValueChange={field.onChange}
                        value={field.value}
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="01">10</SelectItem>
                          <SelectItem value="02">11</SelectItem>
                          <SelectItem value="03">12</SelectItem>
                        </SelectContent>
                      </Select>
                    </FormControl>
                    <FormMessage />
            ...
            <div className="inline-flex justify-start items-start gap-[29px]">
              <div className="relative">
                ...
                <Button variant={"secondary"} className="pl-12" type="button">
                  <Link href="/director/class" className="text-white">
                    Thoát
                  </Link>
                </Button>{" "}
              </div>
              <div className="relative">
                ...
                <Button className="pl-12" type="submit">
                  <Link href="/director/class">Lưu</Link>
                </Button>{" "}
              </div>
            </div>
          </div>
