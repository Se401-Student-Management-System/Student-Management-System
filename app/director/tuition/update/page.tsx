...
export default function pageTuition() {
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="w-full flex flex-col">
                    <FormLabel className="font-normal">Học phí</FormLabel>
                    <FormControl>
            ...
            <div className="inline-flex justify-start items-start gap-[29px]">
              <div className="relative">
                ...
                <Button variant={"secondary"} className="pl-12" type="button">
                  <Link href="/director/tuition" className="text-white">
                    Thoát
                  </Link>
                </Button>{" "}
              </div>
              <div className="relative">
                ...
                <Button className="pl-12" type="submit">
                  <Link href="/director/tuition">Lưu</Link>
                </Button>{" "}
              </div>
            </div>
          </div>
